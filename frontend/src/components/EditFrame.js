...
const EditFrame = ({id, initialConfigs, inverseChecksSelected, getInverseChecks, type, homeRoute, allConfigs}) => {
    ...
    const getUnusedChecks = () => {
        return categories['category-4'].configIds
    }
    ...
    const isValid = () => {
        ...
        if (inverseChecksSelected(getUnusedChecks())) {
    ...
    return (
        <div>
            ...
            <Alert
                ...
                content={'You have selected \'' + getInverseChecks(getUnusedChecks())[0] + '\' and \'' + getInverseChecks(getUnusedChecks())[1] + '\'. Since these checks are the inverse of one another, please select at most one of them.'}
                actions={[
                    {
                        title: 'OK',
