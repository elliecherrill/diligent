export const initialConfigs = {
    ...
    categories: {
        ...
        'category-4': {
            id: 'category-4',
            title: 'Don\'t Check',
            configIds: ['config-2', 'config-3', 'config-4', 'config-5', 'config-12', 'config-13', 'config-14', 'config-15', 'config-16', 'config-17']
...
export const allConfigs = ['config-2', 'config-3', 'config-4', 'config-5', 'config-12', 'config-13', 'config-14', 'config-15', 'config-16', 'config-17']
//TODO: 'config-1',  'config-6', 'config-7', 'config-8', 'config-9', 'config-10', 'config-11'
