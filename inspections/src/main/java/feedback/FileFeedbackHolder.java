...
public class FileFeedbackHolder {
    ...
    private void initMap(Map<InspectionPriority, Integer> changeToPriorities) {
        changeToPriorities.put(InspectionPriority.HIGH, 0);
        changeToPriorities.put(InspectionPriority.MEDIUM, 0);
        changeToPriorities.put(InspectionPriority.LOW, 0);
    }
